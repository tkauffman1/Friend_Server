...
mysql\bin\mysqld --standalone --console --max_allowed_packet=128M --innodb_redo_log_capacity=100MB --binlog_expire_logs_seconds=432000 --innodb_buffer_pool_size=2G --innodb_io_capacity=500 --innodb_io_capacity_max=2500 --innodb_use_fdatasync=ON --innodb_buffer_pool_instances=12 --innodb_log_buffer_size=32M --transaction_isolation="READ-COMMITTED"
